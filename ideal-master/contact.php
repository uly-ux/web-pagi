            ...
            <div class="container">
              <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 text-center">
                  <h1>Hubungi <span class="text-primary">Kami.</span> Now!  </h1>
            ...
            <div class="bg-white p-3 p-md-5">
              ...
              <ul class="list-unstyled footer-link">
                <li class="d-block mb-3">
                  ...
                  <span>Jl. Mr. Mochd Hasan No.100, BATOH, Kec. Darul Imarah, Kota Banda Aceh 23245 </span></li>
                <li class="d-block mb-3"><span class="d-block text-black">Phone:</span><span>+62 242 4942 290</span></li>
                <li class="d-block mb-3"><span class="d-block text-black">Email:</span><span>art@ArchitectureGreat.com</span></li>
              </ul>
            </div>
          </div>
        </div>
