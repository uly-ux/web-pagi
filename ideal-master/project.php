        ...
        <div class="row align-items-stretch feature-2">
          ...
          <div class="col-lg-3 feature-2-contents pl-lg-5">
            <div class="fixed-content">
              ...
              <h2 class="heading-39291">Hunian elit</h2>
              <p>. Ruangan yang Nyaman dan Luas membuat kesan berkumpul lebih menyenangkan.</p>
              <p>Percayakan Design Rumah Idaman Anda kepada Profesional kami. Keindahan, kenyamanan, Art, dan design sesuai dengan harapan Anda. Kami akan mewujudkannya</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-stretch feature-2">
          ...
          <div class="col-lg-3 feature-2-contents pr-lg-5">
            <div class="fixed-content">
              ...
              <h2 class="heading-39291">Tatanan Furniture Ruang</h2>
              <p>Penataan tata letak furniture didalam rumah membuat kesan rumah lebih homey .</p>
        ...
        <div class="row align-items-stretch feature-2">
          ...
          <div class="col-lg-3 feature-2-contents pl-lg-5">
            <div class="fixed-content">
              ...
              <h2 class="heading-39291">Konsep Arsitek Handal</h2>
              <p>Menerapkan arsitek yang terkonsep dan Professional untuk mewujudkan rumah Impian Anda.</p>
              <p>Portofolio arsitek anda tidak diragukan lagi, hasil karya yang membuat anda terkagum dengan ide, inovasi dan kreativitas mereka.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-stretch feature-2">
          ...
          <div class="col-lg-3 feature-2-contents pr-lg-5">
            <div class="fixed-content">
              ...
              <h2 class="heading-39291">Inovasi, Kreativitas, dan Idea</h2>
